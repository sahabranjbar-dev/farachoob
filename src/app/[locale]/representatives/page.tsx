...
const RepresentativesPage = () => {
  ...
  const representatives: Representative[] = [
    ...
    },
    {
      ...
      lastName: "احمدی",
      phone: "09129876543",
      address: "خیابان چهارباغ، کوچه هنر، پلاک ۴۵",
      city: "اصفهان",
      province: "اصفهان",
      latitude: 32.6546,
      longitude: 51.668,
    },
    {
      ...
      lastName: "کریمی",
      phone: "09351234567",
      address: "بلوار وکیل آباد، کوچه سلامت، پلاک ۷۸",
      city: "مشهد",
  ...
  const filteredRepresentatives = representatives.filter((rep) => {
    const matchesSearch =
      `${rep.name} ${rep.lastName} ${rep.phone} ${rep.address} ${rep.city}`
        .toLowerCase()
  ...
  const centerPosition: [number, number] = activeRep
    ? [
        representatives.find((rep) => rep.id === activeRep)?.latitude ||
          35.6892,
        representatives.find((rep) => rep.id === activeRep)?.longitude ||
          51.389,
      ]
                ...
                {filteredRepresentatives.map((rep) => (
                  ...
                  >
                    <Popup>
                      ...
                      <div className="text-blue-600 mt-1">{rep.phone}</div>
                    </Popup>
                  </Marker>
                ))}
              </MapContainer>
